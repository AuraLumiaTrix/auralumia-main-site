  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div><p className="footer-label">RECHTLICHES</p><Link href="/impressum">Impressum</Link><a href="https://jenniferkindereit.wixsite.com/auralumia/datenschutzerkl%C3%A4rung">Datenschutz</a><a href="https://jenniferkindereit.wixsite.com/auralumia/agbs">AGB</a></div>
      </div>
