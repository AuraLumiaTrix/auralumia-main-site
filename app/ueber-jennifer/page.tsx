...
export default function JenniferPage() {
  return <>
    ...
    <section className="principles shell"><p className="eyebrow">DAS FUNDAMENT MEINER ARBEIT</p><div className="principles-grid"><article><span>01</span><h3>Verstand</h3><p>Ihre hochschulzertifizierte Ausbildung im Mentalcoaching gibt ihrer Bewusstseinsarbeit, psychologischen Transformation und neuro-mentalen Verankerung eine klare, fundierte Struktur.</p></article><article><span>02</span><h3>Körper</h3><p>Ihre Ausbildung zur Essence of Belly Dance-Trainerin verbindet fundiertes Beckenbodenwissen, weibliche Ur-Energie und gelebtes Embodiment.</p></article><article><span>03</span><h3>Stimme</h3><p>Ihre fundierte Ausbildung im mystischen und rituellen Folkloregesang verbindet sich mit ihrer Kundalini-Yoga-Einweihung als Chandra Sangeeta. So werden Stimme, Atem und Klang zu einem tragenden Teil ihrer Arbeit mit Erinnerung und Öffnung.</p></article></div></section>
