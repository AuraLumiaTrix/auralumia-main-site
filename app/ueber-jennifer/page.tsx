...
export default function JenniferPage() {
  return <>
    ...
    <section className="jennifer-film shell"><video controls playsInline preload="metadata" poster="/jennifer.webp" aria-label="Jennifer Olivia Kindereit – persönliches Video"><source src={links.portraitVideo} type="video/mp4" /></video><p>Jennifer Olivia · AuraLumia</p></section>
