...
export default function JenniferPage() {
  return <>
    <section className="jennifer-intro shell"><div className="jennifer-intro-copy"><p className="eyebrow">JENNIFER OLIVIA KINDEREIT</p><h1>Ich lese und verwebe die Fäden der Zeit, des Körpers und des Blutes.</h1><p>Als kosmische Weberin, zertifizierter Mentalcoach und Medium verbinde ich die fundierte Arbeit des modernen Verstandes mit der initiatischen Erinnerung alter Linien.</p><Link className="button button-outline" href="/angebote">Mit mir arbeiten</Link></div><div className="jennifer-film"><PortraitVideo src={links.portraitVideo} /></div></section>
