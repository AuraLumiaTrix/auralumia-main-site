...
export default function SomaticKarmaPage() {
  return <>
    ...
    <section className="testimonial-inline shell" aria-labelledby="audio-stimme"><div><p className="eyebrow">STIMME ZUR ANKERMEDITATION</p><h2 id="audio-stimme">Ein Ritual, das im Alltag weiterträgt.</h2></div><div><blockquote>„Diese persönliche Meditation ist für mich eines der schönsten Geschenke, die ich je bekommen habe. Ich höre sie mittlerweile fast jeden Abend. Sie ist mein sicherer Hafen in schwierigen Momenten und gibt mir Kraft und innere Ruhe.“</blockquote><p className="testimonial-attribution"><strong>Elena M.</strong><span>Individuelle Ankermeditation</span></p></div></section>
