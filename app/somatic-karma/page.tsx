...
export default function SomaticKarmaPage() {
  return <>
    ...
    <section className="depth shell"><div className="depth-card"><img src="/audio-bundle.webp" alt="Somatic Karma Audio Bundle" /><div><p className="eyebrow">DEIN ARCHETYP · DEINE PRAXIS</p><h2>Audio Bundle</h2><p>Meditation, Affirmation und Transformationsritual für deinen Hauptarchetypen.</p><strong>47 €</strong><a className="text-link" href={links.audio}>Bundle ansehen</a></div></div><div className="depth-card"><img src="/karma-code.webp" alt="Somatic Karma Code" /><div><p className="eyebrow">DEINE PERSÖNLICHE SIGNATUR</p><h2>Somatic Karma Code</h2><p>Dein Geburtshoroskop und dein Archetyp als persönliche Audioanalyse – Essential oder von Jennifer Olivia eingesprochen.</p><strong>97 € · 333 €</strong><a className="text-link" href={links.code}>Code entdecken</a></div></div></section>
