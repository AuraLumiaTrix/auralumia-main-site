...
export default function MentoringPage() {
  return <>
    ...
    <section className="mentoring-application" id="bewerbung"><div className="shell mentoring-application-grid"><div><p className="eyebrow">ZWEI CIRCLES IM JAHRESKREIS</p><h2>Neun Monde. Zwei Portale. Ein tiefgreifender Weg.</h2><p>Jedes Jahr öffnen sich zwei Aura Luminess Circles: Der Samhain Circle beginnt an Samhain, der Walpurgis Circle an Walpurgis. Jeder Circle begleitet dich über neun Monde in einem bewusst kleinen, persönlich gehaltenen Raum. Die nächste Bewerbungsphase öffnet im Oktober für den Samhain Circle.</p></div><aside className="application-notice"><span>NÄCHSTE BEWERBUNGSPHASE</span><h3>Oktober 2026</h3><p>Für den Aura Luminess Samhain Circle · neun Monde Begleitung</p><strong>Wenige, bewusst vergebene Plätze</strong></aside></div></section>
  </>;
}
