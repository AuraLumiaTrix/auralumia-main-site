    ...
    <>
      ...
      <section className="selected-offers shell">
        ...
        <div className="selected-grid">
          <Link className="selected-card selected-card-wide selected-card-product" href="/angebote#somatic-karma"><img src="/produktbild-audio-bundle.png" alt="Somatic Karma Audio Bundle" /><div><span>AB 27 €</span><h3>Somatic Karma</h3><p>Navigator, Tarot, Audio Bundle und persönliche Analysen.</p></div></Link>
