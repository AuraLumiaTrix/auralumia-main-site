...
export default function MusikPage() {
  return <>
    ...
    <section className="embedded-media shell" id="naru-player"><div className="embedded-media-heading"><p className="eyebrow">RISING OF THE WOMB · PLAYER</p><h2>Bleib hier. Und hör hinein.</h2></div><div className="youtube-frame"><iframe src="https://www.youtube-nocookie.com/embed/rLr9CtIl-OA?playlist=-CfII5sW2Uk,8_4pnSai_Vg,VepDlf7S86Y,TN5086zEU8w" title="Naru Hikari – Rising of the Womb" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section>
