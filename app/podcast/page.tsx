...
export default function PodcastPage() {
  return <>
    ...
    <section className="podcast-stage"><div className="shell podcast-copy"><p className="eyebrow">VOM SCHATTEN INS LICHT</p><h2>Schwere Wege dürfen wieder Süße tragen.</h2><p>Jennifer Olivia lädt dich ein, übernommene Regeln, familiäre Verstrickungen und karmische Muster bewusst zu betrachten – ohne dich auf deine Vergangenheit zu reduzieren.</p><p>Zwischen kosmischen Bildern, Ahnenwissen und einfachen Ritualen entsteht ein persönlicher Reflexionsraum für Selbstbestimmung, Mitgefühl und innere Freiheit.</p><div className="actions"><a className="button button-light" href="#podcast-player">Podcast auf AuraLumia hören</a></div></div></section>
    <section className="embedded-media shell" id="podcast-player"><div className="embedded-media-heading"><p className="eyebrow">KARMA MIT ZIMT & ZUCKER · PLAYER</p><h2>Deine Folgen. Direkt hier.</h2></div><div className="youtube-frame"><iframe src="https://www.youtube-nocookie.com/embed/videoseries?list=UUkEO4NGnBCTXOmOPNcn401A" title="Karma mit Zimt und Zucker – Podcastfolgen" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section>
