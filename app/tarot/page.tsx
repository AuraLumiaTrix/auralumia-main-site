...
export default function TarotPage() {
  return <>
    ...
    <TarotLibrary />
    <section className="tarot-app-band"><div className="shell tarot-app-grid"><div><p className="eyebrow">DIE SOMATIC KARMA TAROT APP</p><h2>Dein geschützter Kartenraum für jeden Tag.</h2><p>Das Archiv hier lässt dich alle Bedeutungen kennenlernen. In der App ziehst du intuitiv Karten, öffnest persönliche Reflexionsimpulse und nutzt den Raum auf Smartphone, Tablet oder Desktop.</p><div className="actions"><a className="button button-light" href={links.tarotCheckout} target="_blank" rel="noreferrer">App-Zugang wählen · 27 €</a></div><small>Alle Details zur App und zum Zugang findest du auf der ausführlichen Landingpage. Sie öffnet sich in einem neuen Tab.</small></div><img src="/products/somatic-tarot-access.png" alt="Somatic Karma Tarot App" /></div></section>
    <section className="testimonial-inline testimonial-inline-app shell" aria-labelledby="tarot-stimme"><div><p className="eyebrow">STIMME ZUR TAROT APP</p><h2 id="tarot-stimme">Intuition, die sich leicht in den Alltag einfügt.</h2></div><div><blockquote>„Ich bin so begeistert von der App. Sie ist intuitiv, wunderschön gestaltet und lässt sich ganz einfach in meinen Tagesablauf integrieren. Besonders liebe ich die Klänge sowie die helle und dunkle Ansicht.“</blockquote><p className="testimonial-attribution testimonial-attribution-with-avatar"><img src="/testimonial-marie-lena-b.png" alt="Marie-Lena B." loading="lazy" /><span><strong>Marie-Lena B.</strong><small>Somatic Karma Tarot App</small></span></p></div></section>
  </>;
}
